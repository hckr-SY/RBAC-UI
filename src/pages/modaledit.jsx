...
export default function ModalEdit(props) {
  ...
  const [Name,setName] = useState(users[props.index].Name);
  const [Email,setEmail] = useState(users[props.index].Email);
  const [Role,setRole] = useState(users[props.index].Role);

  function handleSubmit()
{

    let t = [...users];
    t[props.index].Name = Name;
    t[props.index].Email = Email;
    t[props.index].Role = Role;
